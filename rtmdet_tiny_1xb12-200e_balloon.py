...
# batch 改变了，学习率也要跟着改变， 0.004 是 1卡x32 的学习率
base_lr = 12 * 0.004 / (32 * 1)
...
train_dataloader = dict(
    ...
    pin_memory=False,
    dataset=dict(
        data_root=data_root,  # 改成自己的
        metainfo=metainfo,
        ann_file='train.json',  # 改成自己的
...
# 一些打印设置修改
default_hooks = dict(
    checkpoint=dict(interval=10, max_keep_ckpts=3, save_best='auto'),  # 同时保存最好性能权重
